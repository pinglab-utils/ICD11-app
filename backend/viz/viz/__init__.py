...
sys.path.insert(0, '/var/www/app/backend/viz/viz')

#import number of nodes per level for each root
df = pd.read_csv("/var/www/app/backend/viz/viz/withoutsum.csv")
...
df2 = pd.read_csv("/var/www/app/backend/viz/viz/withsum.csv")
...
with open('/var/www/app/backend/viz/viz/intersecting_nodes.txt', 'r') as filehandle:
